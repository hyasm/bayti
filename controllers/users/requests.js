...
module.exports = {
    ...
    View: async (req, res, next) => {
        ...
        try {
            const request = await RequestModel.findOne({
                _id: requestId,
                user: userdata.id
            }).populate(["provider", "deed_land", "map", "build_permit"]);
            ...
            res.render("users/requests/view", {
    ...
    Create: async (req, res, next) => {
        ...
        try {
            if (req.method === "POST") {
                const { values, errors } = await Validate.Request.Create({
                    request: req,
                    source: "body",
                });
                ...
                if (errors) {
                    ...
                    return res.redirect("/dashboard/requests/create");
                }

                const createRequest = await new RequestModel({
                ...
                if (createRequest) {
                    req.setMessage("تم انشاء الطلب بنجاح سيتم مراجعة الطلب من قبل مزودي الخدمات");
                }else{
            ...
            res.render("users/requests/create", {
                title: "ادارة الطلبات - انشاء",
                menuId: "requests",
            });
        } catch (error) {
            req.setParams(req.body);
    ...
    Update: async (req, res, next) => {
        ...
        try {
            ...
            res.render("users/requests/update", {
    ...
    Delete: async (req, res, next) => {
        ...
        try {
            ...
            res.render("users/requests/delete", {
